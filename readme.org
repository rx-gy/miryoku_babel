...
~MIRYOKU_ALPHAS=RECURVA~

#+NAME: recurva
| F    | R    | D    | P    | V    | Q    | J    | U    | O    | Y    |
| S    | N    | T    | C    | B    | DOT  | H    | E    | A    | I    |
| Z    | X    | K    | G    | W    | M    | L    | ;    | '    | ,    |
...
#include "miryoku_layer_alternatives.h"
    ...
    #elif defined (MIRYOKU_ALPHAS_RECURVA)
      #define MIRYOKU_LAYER_BASE MIRYOKU_ALTERNATIVES_BASE_RECURVA
    #elif defined (MIRYOKU_ALPHAS_BEAKL15)
  ...
  #define MIRYOKU_LAYERMAPPING_BASE MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_EXTRA_RECURVA)
      #define MIRYOKU_LAYER_EXTRA MIRYOKU_ALTERNATIVES_BASE_RECURVA
    #elif defined (MIRYOKU_EXTRA_BEAKL15)
  ...
  #define MIRYOKU_LAYERMAPPING_EXTRA MIRYOKU_MAPPING
    ...
    #elif defined (MIRYOKU_TAP_RECURVA)
      #define MIRYOKU_LAYER_TAP MIRYOKU_ALTERNATIVES_TAP_RECURVA
    #elif defined (MIRYOKU_TAP_BEAKL15)
...
<<table-layer-taphold(alphas_table=recurva)>>
...
<<table-layer-full(current_layer_name="U_TAP", alphas_table=recurva, thumbs_table=thumbs)>>
